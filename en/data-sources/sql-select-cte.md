...
This data source is optimized using Common Table Expressions \(CTE\) and it makes your Grid load from 16 seconds to...almost instantly! See the[ video](https://youtu.be/tpUOEIriD9o). 
